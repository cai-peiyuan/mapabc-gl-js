...
test('Marker#addTo adds the marker element to the canvas container', (t) => {
    ...
    t.equal(map.getCanvasContainer().querySelectorAll('.mapabcgl-marker').length, 1);
...
test('Marker anchor defaults to center', (t) => {
    ...
    t.ok(marker.getElement().classList.contains('mapabcgl-marker-anchor-center'));
...
test('Marker anchors as specified by the anchor option', (t) => {
    ...
    t.ok(marker.getElement().classList.contains('mapabcgl-marker-anchor-top'));
...
test('Popup anchors around default Marker', (t) => {
    ...
    t.ok(marker.getPopup()._container.classList.contains('mapabcgl-popup-anchor-bottom'), 'popup anchors above marker');

    // move marker to the top forcing the popup to below
    marker.setLngLat(map.unproject([mapHeight / 2, markerTop]));
    t.ok(marker.getPopup()._container.classList.contains('mapabcgl-popup-anchor-top'), 'popup anchors bolow marker');

    // move marker to the right forcing the popup to the left
    marker.setLngLat(map.unproject([mapHeight - markerRight, mapHeight / 2]));
    t.ok(marker.getPopup()._container.classList.contains('mapabcgl-popup-anchor-right'), 'popup anchors left of marker');

    // move marker to the left forcing the popup to the right
    marker.setLngLat(map.unproject([markerRight, mapHeight / 2]));
    t.ok(marker.getPopup()._container.classList.contains('mapabcgl-popup-anchor-left'), 'popup anchors right of marker');

    // move marker to the top left forcing the popup to the bottom right
    marker.setLngLat(map.unproject([markerRight, markerTop]));
    t.ok(marker.getPopup()._container.classList.contains('mapabcgl-popup-anchor-top-left'), 'popup anchors bottom right of marker');
    ...
    t.ok(marker.getPopup()._container.classList.contains('mapabcgl-popup-anchor-top-right'), 'popup anchors bottom left of marker');

    // move marker to the bottom left forcing the popup to the top right
    marker.setLngLat(map.unproject([markerRight, mapHeight]));
    t.ok(marker.getPopup()._container.classList.contains('mapabcgl-popup-anchor-bottom-left'), 'popup anchors top right of marker');
    ...
    t.ok(marker.getPopup()._container.classList.contains('mapabcgl-popup-anchor-bottom-right'), 'popup anchors top left of marker');
