...
const test = require('mapabc-gl-js-test').test;
const fs = require('fs');
...
test('@mapabc/mapabc-gl-style-spec npm package', (t) => {
    ...
    t.test('exports components directly, not behind `default` - https://github.com/mapabc/mapabc-gl-js/issues/6601', (t) => {
