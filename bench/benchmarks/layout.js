...
import VT from '@mapabc/vector-tile';
...
import { normalizeStyleURL, normalizeSourceURL, normalizeTileURL } from '../../src/util/mapabc';
...
export default class Layout extends Benchmark {
    ...
    fetchStyle(): Promise<StyleSpecification> {
        return fetch(normalizeStyleURL(`mapabc://styles/mapabc/streets-v9`))
