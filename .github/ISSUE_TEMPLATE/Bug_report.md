...
Hello! Thanks for contributing.  For the fastest response and resolution, please:
 ...
 - Only post to report a bug. For feature requests, please use https://github.com/mapabc/mapabc-gl-js/issues/new?template=Feature_request.md instead.  Direct all other questions to https://stackoverflow.com/questions/tagged/mapabc-gl-js
