...
class NavControl {
	...
	_calcContainerStyle() {
		if(this.options.position == 'bottom-right'){
			this._amapControlbar.style.right='8px';
			this._amapControlbar.style.bottom='10px';
			...
			this._amapControlbar.style.left='-108px';
			this._amapControlbar.style.bottom='10px';
		}
	}
    ...
    _createDiv(className: string, ariaLabel: string, fn: () => mixed) {
