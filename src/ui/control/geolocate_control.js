 ...
 *
 * @example
 * map.addControl(new mapabcgl.GeolocateControl({
 *     positionOptions: {
 *         enableHighAccuracy: true
 *     },
 *     trackUserLocation: true
 * }));
 * @see [Locate the user](http://www.mapabc.com/mapabc-gl-js/example/locate-user/)
 */
class GeolocateControl extends Evented {
    ...
    _onSuccess(position: Position) {
        if (this.options.trackUserLocation) {
            ...
            case 'ACTIVE_ERROR':
                ...
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-waiting');
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-active-error');
                this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-active');
                break;
            case 'BACKGROUND':
            case 'BACKGROUND_ERROR':
                this._watchState = 'BACKGROUND';
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-waiting');
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-background-error');
                this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-background');
                break;
            default:
        ...
        if (this.options.showUserLocation) {
            this._dotElement.classList.remove('mapabcgl-user-location-dot-stale');
        }
    ...
    _onError(error: PositionError) {
        if (this.options.trackUserLocation) {
            if (error.code === 1) {
                ...
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-waiting');
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-active');
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-active-error');
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-background');
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-background-error');
                ...
                case 'WAITING_ACTIVE':
                    ...
                    this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-active');
                    this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-active-error');
                    break;
                case 'ACTIVE_LOCK':
                    this._watchState = 'ACTIVE_ERROR';
                    this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-active');
                    this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-active-error');
                    this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-waiting');
                    // turn marker grey
                    break;
                case 'BACKGROUND':
                    this._watchState = 'BACKGROUND_ERROR';
                    this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-background');
                    this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-background-error');
                    this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-waiting');
                    // turn marker grey
                    break;
                case 'ACTIVE_ERROR':
        ...
        if (this._watchState !== 'OFF' && this.options.showUserLocation) {
            this._dotElement.classList.add('mapabcgl-user-location-dot-stale');
        }
    ...
    _setupUI(supported: boolean) {
        ...
        if (this.options.showUserLocation) {
            this._dotElement = DOM.create('div', 'mapabcgl-user-location-dot');
