...
import isSupported from '@mapabc/mapabc-gl-supported';
 ...
 * the schema described in the [Mapbox Style Specification](https://mapabc.com/mapabc-gl-style-spec/), or a URL to
 * such JSON.
 *
 ...
 *  * `mapabc://styles/mapabc/light-v9`
 *  * `mapabc://styles/mapabc/dark-v9`
 *  * `mapabc://styles/mapabc/satellite-v9`
 *  * `mapabc://styles/mapabc/satellite-streets-v10`
 *  * `mapabc://styles/mapabc/navigation-preview-day-v2`
 *  * `mapabc://styles/mapabc/navigation-preview-night-v2`
 *  * `mapabc://styles/mapabc/navigation-guidance-day-v2`
...
class Map extends Camera {
     ...
     *   [Mapbox Style Specification](https://mapabc.com/mapabc-gl-style-spec/), or a URL to such JSON.
     * @param {Object} [options]
    ...
    _detectMissingCSS(): void {
        ...
        if (computedColor !== 'rgb(250, 128, 114)') {
            warnOnce('This page appears to be missing CSS declarations for ' +
                'MapAbc GL JS, which may cause the map to display incorrectly. ' +
...
/**
 * A [`Point` geometry](https://github.com/mapabc/point-geometry) object, which has
