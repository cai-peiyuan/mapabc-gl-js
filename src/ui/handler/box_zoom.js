...
class BoxZoomHandler {
    ...
    _onMouseMove(e: MouseEvent) {
        ...
        if (!this._box) {
            this._box = DOM.create('div', 'mapabcgl-boxzoom', this._container);
            this._container.classList.add('mapabcgl-crosshair');
    ...
    _finish() {
        ...
        this._container.classList.remove('mapabcgl-crosshair');
