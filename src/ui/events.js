 ...
 * - `'style'`: The [style](http://www.mapabc.com/mapabc-gl-style-spec/) used by the map
 *
 * @typedef {Object} MapDataEvent
 * @property {string} type The event type.
 * @property {string} dataType The type of data that has changed. One of `'source'`, `'style'`.
 * @property {boolean} [isSourceLoaded] True if the event has a `dataType` of `source` and the source has no outstanding network requests.
 * @property {Object} [source] The [style spec representation of the source](http://www.mapabc.com/mapabc-gl-style-spec/#sources) if the event has a `dataType` of `source`.
...
export type MapEvent =
     ...
     * @instance
     * @property {MapMouseEvent} data
     * @see [Get coordinates of the mouse pointer](http://www.mapabc.com/mapabc-gl-js/example/mouse-position/)
     * @see [Highlight features under the mouse pointer](http://www.mapabc.com/mapabc-gl-js/example/hover-styles/)
     ...
     * @see [Get coordinates of the mouse pointer](http://www.mapabc.com/mapabc-gl-js/example/mouse-position/)
     * @see [Highlight features under the mouse pointer](http://www.mapabc.com/mapabc-gl-js/example/hover-styles/)
     * @see [Display a popup on over](http://www.mapabc.com/mapabc-gl-js/example/popup-on-hover/)
     */
    | 'mousemove'
     ...
     * @instance
     * @property {{originalEvent: DragEvent}} data
     * @see [Play map locations as a slideshow](http://www.mapabc.com/mapabc-gl-js/example/playback-locations/)
     ...
     * @instance
     * @property {MapMouseEvent | MapTouchEvent} data
     * @see [Update a choropleth layer by zoom level](http://www.mapabc.com/mapabc-gl-js/example/updating-choropleth/)
     */
    | 'zoom'
