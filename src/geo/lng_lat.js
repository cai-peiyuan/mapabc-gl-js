 ...
 * @example
 * var ll = new mapabcgl.LngLat(-73.9749, 40.7736);
...
class LngLat {
     ...
     * @example
     * var ll = new mapabcgl.LngLat(286.0251, 40.7736);
     * var wrapped = ll.wrap();
     * wrapped.lng; // = -73.9749
     */
    wrap() {
     ...
     * var ll = mapabcgl.LngLat.convert(arr);
 ...
 * @example
 * var v1 = new mapabcgl.LngLat(-122.420679, 37.772537);
