 ...
 * @example
 * var sw = new mapabcgl.LngLat(-73.9876, 40.7661);
 * var ne = new mapabcgl.LngLat(-73.9397, 40.8002);
 * var llb = new mapabcgl.LngLatBounds(sw, ne);
 */
class LngLatBounds {
    _ne: LngLat;
    _sw: LngLat;
     ...
     * @example
     * var llb = new mapabcgl.LngLatBounds([-73.9876, 40.7661], [-73.9397, 40.8002]);
    ...
    * @returns {number} The north edge of the bounding box.
     ...
     * var llb = mapabcgl.LngLatBounds.convert(arr);
 ...
 * @example
 * var v1 = new mapabcgl.LngLatBounds(
 *   new mapabcgl.LngLat(-73.9876, 40.7661),
 *   new mapabcgl.LngLat(-73.9397, 40.8002)
 * );
 * var v2 = new mapabcgl.LngLatBounds([-73.9876, 40.7661], [-73.9397, 40.8002])
