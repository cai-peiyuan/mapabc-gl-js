...
class LineBucket implements Bucket {
    ...
    addLine(vertices: Array<Point>, feature: VectorTileFeature, join: string, cap: string, miterLimit: number, roundLimit: number, index: number) {
        ...
        if (!!feature.properties &&
            feature.properties.hasOwnProperty('mapabc_clip_start') &&
            feature.properties.hasOwnProperty('mapabc_clip_end')) {
            lineDistances = {
                start: feature.properties.mapabc_clip_start,
                end: feature.properties.mapabc_clip_end,
                tileTotal: undefined
            };
        }
